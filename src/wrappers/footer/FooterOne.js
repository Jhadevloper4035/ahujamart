...
const FooterOne = ({
  ...
  return (
    ...
    style={{
      backgroundImage: "url('assets/img/banner/banner50.jpg')",
    ...
    >
      ...
      <h5 style={{textAlign : "center" , textTransform: "uppercase"}}>
        ...
        Ahuja Mart  All Rights Reserved  Powerd By
        <a href="https://rantechnology.in/"  rel="noopener noreferrer" target="_blank" > Ratechnology </a> 
      </h5>
    </footer>
  );
};
